...
public class ReadMe {
    ...
    public void setNorthPanel(JPanel north){                                    //add heading "Read Me" to northPanel
        northPanel = north; 
        northPanel.removeAll();
        
        BoxLayout boxLayout = new BoxLayout(northPanel, BoxLayout.Y_AXIS);
        northPanel.setLayout(boxLayout);
        northPanel.setBorder(new EmptyBorder(6, 291, 4, 0));
       
        Images readMe = new Images("readmetitle");
        readMe.setOpaque(false);
        readMe.setPreferredSize(new Dimension(272, 43));
        northPanel.add(readMe);
    }
}
