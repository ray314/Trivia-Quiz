...
public class PlayerDetails {
    ...
    public void setNorthPanel(JPanel north){                                    //add heading "Game Setup" to northPanel
        northPanel = north; 
        northPanel.removeAll();
        
        BoxLayout boxLayout = new BoxLayout(northPanel, BoxLayout.Y_AXIS);
        northPanel.setLayout(boxLayout);
        northPanel.setBorder(new EmptyBorder(6, 234, 4, 0));
       
        Images setup = new Images("gamesetup");
        setup.setOpaque(false);
        setup.setPreferredSize(new Dimension(382, 48));
        northPanel.add(setup);
    }
}
