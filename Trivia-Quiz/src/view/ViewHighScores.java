...
public class ViewHighScores {
    ...
    public void setNorthPanel(JPanel north){                                    //add heading "High Scores" to northPanel
        northPanel = north;
        northPanel.removeAll();
        
        BoxLayout boxLayout = new BoxLayout(northPanel, BoxLayout.Y_AXIS);
        northPanel.setLayout(boxLayout);
        northPanel.setBorder(new EmptyBorder(6, 231, 4, 23)); 
               
        Images highScores = new Images("highscores");
        highScores.setOpaque(false);
        highScores.setPreferredSize(new Dimension(391, 54));
        northPanel.add(highScores);
    }
}
