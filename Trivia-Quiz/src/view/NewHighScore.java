...
public class NewHighScore{
    ...
    public void setNorthPanel(JPanel north){                                    //add heading "New High Score" to northPanel
        northPanel = north;
        northPanel.removeAll();
           
        BoxLayout northPanelLayout = new BoxLayout(northPanel, BoxLayout.Y_AXIS);
        northPanel.setLayout(northPanelLayout);
        northPanel.setBorder(new EmptyBorder(5, 166, 5, 100));                  //(top, left, bottom, right)
 
        Images newHighScore = new Images("newhighscore");
        newHighScore.setOpaque(false);
        newHighScore.setPreferredSize(new Dimension(524, 54));
        northPanel.add(newHighScore);
    }
}
